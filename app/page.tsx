  ...
  return (
    <>
      ...
      <main>
        ...
        <section id="home" className="min-h-screen flex items-center relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-6 w-full py-32 relative">
            ...
            <FadeIn delay={100}>
              <h1 className="text-6xl sm:text-7xl font-semibold text-stone-900 tracking-tight mb-8 leading-none">
                Gianluca
                <br />
                DeRossi
              </h1>
            ...
            <FadeIn delay={200}>
              <p className="text-xl text-stone-500 max-w-lg mb-12 leading-relaxed">
            ...
            <FadeIn delay={300}>
              <div className="flex flex-wrap gap-4">
                ...
                <a
                  href="#contact"
                  className="border border-stone-300 text-stone-700 px-6 py-3 rounded-full text-sm font-medium hover:border-stone-500 transition-colors"
                >
                  Get in touch
                </a>
              </div>
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-12 items-start">
              ...
              <FadeIn delay={100} className="md:col-span-2">
                <h2 className="text-3xl font-semibold text-stone-900 mb-6 tracking-tight leading-snug">
                ...
                <div className="grid grid-cols-2 gap-8">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <span
                          key={tag}
                          className="bg-white border border-stone-200 text-stone-600 text-xs px-3 py-1 rounded-full"
                        >
                          {tag}
                        </span>
                      ))}
                  ...
                  <div>
                    ...
                    <p className="text-stone-700 text-sm font-medium">MBA</p>
                    <p className="text-stone-400 text-xs mb-2">Manhattan College</p>
                    <p className="text-stone-700 text-sm font-medium">
                      BA, Marketing &amp; Digital Media
                    </p>
                    <p className="text-stone-400 text-xs">Manhattan College</p>
                  </div>
                </div>
              </FadeIn>
            </div>
        ...
        <section id="work" className="py-24">
          <div className="max-w-5xl mx-auto px-6">
            <FadeIn>
              ...
              <h2 className="text-3xl font-semibold text-stone-900 mb-16 tracking-tight">
                ...
                <FadeIn key={cs.id} delay={i * 100}>
                  <div className="grid md:grid-cols-3 gap-10">
                    <div>
                      ...
                      <p className="text-xs text-stone-400 mb-4">{cs.period}</p>
                      <div className="flex flex-wrap gap-1 mb-8">
                        {cs.tags.map((t) => (
                          <span
                            key={t}
                            className="bg-stone-100 text-stone-500 text-xs px-2 py-0.5 rounded"
                          >
                            {t}
                          </span>
                        ))}
                    ...
                    <div className="md:col-span-2">
                      <h3 className="text-xl font-semibold text-stone-900 mb-8 leading-snug">
                        {cs.headline}
                      </h3>
                  ...
                  {i < caseStudies.length - 1 && (
                    <div className="mt-24 border-t border-stone-100" />
                  )}
                </FadeIn>
              ))}
            </div>
              ...
              {skills.map((group, i) => (
                <FadeIn key={group.category} delay={i * 80}>
                  <div className="bg-white rounded-2xl p-6 border border-stone-200 h-full">
                    <p className="text-sm font-semibold text-stone-800 mb-5">
                      {group.category}
                    </p>
            ...
            <div className="max-w-5xl mx-auto px-6 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a
                  ...
                  className="bg-stone-900 text-white px-8 py-3 rounded-full text-sm font-medium hover:bg-stone-700 transition-colors"
                >
                  Email me
                </a>
                <a
                  ...
                  className="border border-stone-300 text-stone-700 px-8 py-3 rounded-full text-sm font-medium hover:border-stone-500 transition-colors"
                >
                  LinkedIn
                </a>
                <a
      ...
      <footer className="py-8 border-t border-stone-200">
        <div className="max-w-5xl mx-auto px-6 flex justify-between items-center text-xs text-stone-400">
